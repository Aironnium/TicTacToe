    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        if (win.value != null) {
            ...
            Button(onClick = {
                ...
                Text(text = "Click to play again")
            }
        }
    }
}
// Можливі варіанти завершення гри
...
fun getComposableFromMove(move: Boolean?){
    when (move){
        //Іконка гравця
        true -> Image(painter = painterResource(id = R.drawable.ic_x),
            contentDescription =  null,
            modifier = Modifier.fillMaxSize(1f),
            colorFilter = ColorFilter.tint(Color.Blue)
        )
        //Іконка комп'ютера
        false -> Image(painter = painterResource(id = R.drawable.ic_o),
            contentDescription =  null,
            modifier = Modifier.fillMaxSize(1f),
            colorFilter = ColorFilter.tint(Color.Red)
        )
        //Іконка з незайманим сектором
